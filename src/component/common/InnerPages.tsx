...
const InnerPages = () => {
  ...
  // if(id===93187332)
  let innerPageSections = id===93187332?innerPageData?.sections[7].contents: id===24947658?innerPageData?.sections[3].contents: id===67870362?innerPageData?.sections[5].contents: id===17779663?innerPageData?.sections[0].contents: id===32157115?innerPageData?.sections[1].contents: id===59789662?innerPageData?.sections[6].contents: id===45523481?innerPageData?.sections[8].contents: id===43105675?innerPageData?.sections[3].contents: id===11771867?innerPageData?.sections[3].contents: id===29788625?innerPageData?.sections[3].contents:undefined
