            ...
            <><View style={{margin:5}}>
             ...
             <View>
                 <Image
                   style={styles.storyImage}
                   source={{
                     uri: 'https://mpstdc.com/assets/storyImg2.3402ffb6.jpg',
                   }} />
                 <View style={styles.textBox}>
                   <Text style={styles.storyText}>
                   Awesome Orchha Lovely Betwa Retreat All covid norms followed very nice and sincere staff my second visit to this beautiful resort and the level of service goes up and out of the way. Mouth watering food especially the barbeque and above all a personal bonfire.
                   </Text>
                 </View>
               </View></>
